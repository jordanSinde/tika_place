...
class _PaymentScreenState extends ConsumerState<PaymentScreen> {
  ...
  bool _isLoadingReservation = true;
  String? _error;
  ...
  Future<void> _loadReservation() async {
    try {
      final reservation = await ref
          ...
          .getReservationById(widget.bookingReference);
      ...
      if (!reservation.status.canRetryPayment) {
        setState(() {
          _error = 'Cette réservation ne peut plus être payée';
          _isLoadingReservation = false;
        });
        return;
      }
  ...
  Widget _buildMaxAttemptsReached(int remainingTimeInHours) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Paiement'),
        leading: IconButton(
  ...
  Future<void> _handlePaymentCode(String code) async {
    ...
    try {
      ...
      // Simuler un succès aléatoire (à remplacer par vrai appel API)
  ...
  // ... [Rest of the code: _showErrorDialog, _buildAmountCard, _buildPaymentMethods, etc.]
