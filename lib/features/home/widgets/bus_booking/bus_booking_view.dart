...
class _BusBookingViewState extends ConsumerState<BusBookingView> {
  BusClass _selectedClass = BusClass.economy;
  ...
  Widget _buildClassCard({
    ...
    required BusClass busClass,
  }) {
    final isSelected = _selectedClass == busClass;

    return GestureDetector(
      onTap: () {
        setState(() {
          _selectedClass = busClass;
        });
      },
      child: Container(
        width: 200,
